...
public class ActivityManager implements PlaceChangeEvent.Handler, PlaceChangeRequestEvent.Handler {
    ...
    */
    public ResettableEventBus getActiveEventBus() {
    ...
    protected void setStartingNext(boolean startingNext) {
        this.startingNext = startingNext;
    }

    protected boolean isStartingNext() {
        return startingNext;
    }
